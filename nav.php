...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li <?php if($_SERVER['SCRIPT_NAME'] == '/blog/form.php'){ ?>class="active" style="border-left:4px solid <?php echo $latarbg; ?>;"<?php } ?>><a href="index.php"><svg class="glyph stroked app window with content"><use xlink:href="#stroked-app-window-with-content"/></svg> JSON Table</a></li>
